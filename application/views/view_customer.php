...
$config['base_url'] = base_url( $this->config->item('index_page') . '/customer/' );
    ...
    <div class="col-xs-12">
      <div class="box">
        <div class="box-header">
            ...
            <form style="display: inline" class = 'form-inline' id = 'frmSearch' action="<?php echo base_url($this->config->item('index_page') . '/customer/' ) ?>" method = "post" >
                <label>Tier</label>&nbsp;:&nbsp;
                ...
                &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <button type = "button" class = "btn btn-warning btn_sync" >Sync Customers</button>
          ...
          <table id="example2" class="table table-bordered table-hover">
            <thead>
              <tr class = "text-center">
                ...
                <th class = "text-center" ><a href = "javascript:sort('orders_count');" >Orders</th>
                <th class = "text-center" ><a href = "javascript:sort('total_spent');" >Total($)</th>
                <th class = "text-center" >Company</th>
                <th class = "text-center" >Company Number</th> 
                <th class = "text-center" >Company Doc</th>  
                <th class = "text-center" ><a href = "javascript:sort('updated_at');" >Checkout Date</a></th>
              </tr>
            </thead>
            <tbody>
            <?php $sno = $page;
            foreach ($query->result() as $row): $sno ++; ?>
              <tr class="tbl_view text-center" >
                ...
                <td><a href = "<?= $row->id ?>" ><?=$row->company_doc ?></a></td>
...
$(document).ready(function(){
  ...
  $('.btn_sync').click(function(){
    ...
    $.ajax({
      url: '<?php echo base_url($this->config->item('index_page') . '/customer/sync') ?>',
      type: 'GET'
    }).done(function(data) {
      console.log( data );
      if( data == 'success' )
  ...
  $('.btn_save').click( function(){
    ...
    $.ajax({
      url: '<?php echo base_url($this->config->item('index_page') . '/customer/updateDelivery') ?>/' + id,
      data : {
